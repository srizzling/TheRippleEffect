...
class TokenFetcher {
	 ...
	 */
	public static function getToken($userID, $current_token){
	 ...
	 */
	private static function checkForExistingToken($current_token){
	 ...
	 * @return 		  The token that was generated or false if there is no match
	 */
	private static function checkForExistingID($userID){
